...
import com.github.kriaktus.restaurantvoting.service.VoteService;
import com.github.kriaktus.restaurantvoting.to.VoteTo;
import com.github.kriaktus.restaurantvoting.util.VoteUtil;
...
public class AdminVoteController {
    ...
    public List<VoteTo> getAllByDate(@Parameter(description = "dd.MM.yyyy") @RequestParam LocalDate date) {
        ...
        return VoteUtil.toVoteTo(voteRepository.getAllByDate(date));
    }
    ...
    public List<VoteTo> getAll() {
        ...
        return VoteUtil.toVoteTo(voteRepository.findAll());
    }
