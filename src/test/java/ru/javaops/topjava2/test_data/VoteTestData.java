...
import static ru.javaops.topjava2.test_data.UserTestData.ADMIN_ID;
import static ru.javaops.topjava2.test_data.UserTestData.USER_ID;
...
public class VoteTestData {
    ...
    public static Vote getNewVote() {
        return new Vote(null, USER_ID, LocalDate.now().plusDays(1), restaurant1);
    }
}
